...
onMounted(() => {
    stripe = Stripe("pk_test_51MJyvCEAgQFECaeFNpasPUKYvx51hoIWXHmxQ6rGgMfPL4yMCRgV9qSKEWyySZFV9OoMr4MMUgCdptNNosBCONOC00lJpTdaC5");stripe = Stripe("pk_test_0wtMWxWJxMyjyYP2WfpvqHJb");
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="py-4 mt-2 max-w-7xl mx-auto text-3xl font-extrabold">Paiement</div>
        <div class="flex max-w-7xl mx-auto pt-4">
            <div class="w-7/12">
                <div class="flex items-stretch border-b border-b-gray-300 w-[calc(100%-100px)] pb-4   mb-6">
            ...
            <div class="w-5/12 border border-gray-400 rounded-md py-4 px-2">
        ...
        <div class="max-w-7xl mx-auto text-xl font-bold pb-2 underline">Items</div>
        <div class="max-w-7xl mx-auto" v-for="prod in JSON.parse(order.items)" :key="prod">
