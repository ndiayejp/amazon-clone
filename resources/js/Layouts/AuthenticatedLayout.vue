                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            <div class="text-[13px]  text-gray-300 font-extrabold">
                                <div>Livraison à {{ $page.props.auth.user.first_name }}</div>
                            </div>
                            ...
                            <div v-if="accountAndList" class="bg-white absolute z-50 top-[56px] -ml-[230px] w-[480px] rounded-sm px-6">
                                <div v-if="$page.props.auth.user">
                                    <div class="flex items-center justify-between py-2.5 border-b">
                                        <div class="text-smp-2">Qui fait les courses ? Sélectionnez un profil.</div>
                                        <div class="flex items-center text-sm font-bold text-teal-600 hover:text-red-600 hover:underline">
                                            Gérer le profil <ChevronRightIcon :size="20" fillColor="#808080" />
                                        </div>
                                    </div>
                                    <div class="flex">
                                        <div class="w-1/2 border-r">
                                            <div class="pb-3">
                                                ...
                                                <div class="text-sm hover:text-red-600 hover:underline pt-3">Créer une liste</div>
                                            </div>
                                        </div>
                                        <div class="w-1/2 ml-5">
                                            <div class="pb-3">
                                                ...
                                                method="post"
                                                as="button"
                                                class="text-sm block hover:text-red-600 hover:underline pt-3">Déconnexion</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="flex items-center justify-between bg-[#232f3e] h-[38px] fixed z-40 min-w-[1150px] w-full mt-[60px]">
                <div class="flex">
                    ...
                    <div class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                        <div class="flex items-center justify-between px-2">
                            <div class="text-[14px] text-white font-extrabold">Acheter à nouveau</div>
                        </div>
                    </div>
                    <div class="flex h-[30px] border-[1px] border-[#232f3e] rounded-sm hover:border-[1px] hover:border-gray-100 cursor-pointer">
                        <div class="flex items-center justify-between px-2">
        ...
        <footer class="bg-[#232F3E]">
            ...
            <div class="container mx-auto">
                ...
                <ul>
                    ...
                    <li class="hover:underline cursor-pointer">Carrières</li>
                ...
                <ul>
                    ...
                    <li class="hover:underline cursor-pointer">Devenir un affilié</li>
                    ...
                    <li class="hover:underline cursor-pointer">Héberger un Amazon Hub</li>
                </ul>
